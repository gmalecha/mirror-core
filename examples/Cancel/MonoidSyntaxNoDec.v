...
Module Syntax (M : Monoid).
  ...
  Reify Pattern patterns_monoid += (RPi (RGet 0 RIgnore) (RGet 1 RIgnore)) =>
    (fun (t : function (CCall reify_monoid_typ)) (b : function (CCall reify_monoid)) => App (known (All t)) (Abs t b)).
  Reify Pattern patterns_monoid += (@RImpl (@RGet 0 RIgnore) (@RGet 1 RIgnore)) =>
    (fun (a b : function (CCall reify_monoid)) => App (App (known Impl) a) b).
