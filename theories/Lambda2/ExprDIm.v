...
(** Parameters & Axioms **)
  ...
  (** TODO: To fit with everything else I need a list of types.
   ** As I saw in Poly, it is not sufficient for this to be a parameter.
   ** Unfortunately, if it isn't a parameter, then almost nothing can
   ** be a parameter.
   **)

  (** Supporting a weaker notion of type equality, e.g. beta reduction,
   ** would be nice, but it doesn't seem like it is feasible.
   **)
