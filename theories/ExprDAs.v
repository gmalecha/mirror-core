...
Section parameterized.
  ...
  : forall (tus0 tvs0 : tenv typ) (l0 : expr)
           (lD : hlist (typD nil) tus0 -> hlist (typD nil) tvs0 -> T),
      exprD'_typ0 tus0 tvs0 l0 = Some lD ->
      forall tus' tvs' : list typ,
      exists
        lD' : hlist (typD nil) (tus0 ++ tus') -> hlist (typD nil) (tvs0 ++ tvs') -> T,
        exprD'_typ0 (tus0 ++ tus') (tvs0 ++ tvs') l0 = Some lD' /\
        (forall (us : hlist (typD nil) tus0) (vs : hlist (typD nil) tvs0)
                (us' : hlist (typD nil) tus') (vs' : hlist (typD nil) tvs'),
  ...
  : forall (tus0 tvs0 : tenv typ) (l0 : expr)
      ...
      forall tus' : list typ,
      exists
        lD' : hlist (typD nil) (tus0 ++ tus') -> hlist (typD nil) tvs0 -> T,
  ...
  : forall (tus0 tvs0 : tenv typ) (l0 : expr)
      ...
      forall tvs' : list typ,
      exists
        lD' : hlist (typD nil) tus0 -> hlist (typD nil) (tvs0 ++ tvs') -> T,
